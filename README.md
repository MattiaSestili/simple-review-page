...
Run the prettier auto format to correct stylistic errors, similar to eslint above.
it has been set up in a way the two of them won't conflict one another
